      ...
      <div className="grid lg:grid-cols-2 gap-6 md:gap-10">
        ...
        <div className="bg-gradient-to-r from-gray-300 to-gray-200 p-4 sm:p-6 md:p-8 rounded-2xl shadow-md hover:bg-transparent hover:border hover:border-gray-300 transition-all duration-300">
          ...
          <div className="grid gap-4 sm:gap-5">
            ...
            <SkillItem
              icon={<AiOutlineJavaScript className="text-4xl sm:text-5xl text-yellow-300" />}
              stars={4}
              level="Experienced"
            />
            <SkillItem
            ...
            />
            <SkillItem
              icon={<RiReactjsLine className="text-4xl sm:text-5xl text-blue-500" />}
              stars={4}
              level="Intermediate"
            />
          </div>
        ...
        <div className="bg-gradient-to-r from-gray-300 to-gray-200 p-4 sm:p-6 md:p-8 rounded-2xl shadow-md hover:bg-transparent hover:border hover:border-gray-300 transition-all duration-300">
          ...
          <div className="grid gap-4 sm:gap-5">
            ...
            <SkillItem
              icon={<RiNextjsLine className="text-4xl sm:text-5xl text-gray-900" />}
              stars={3}
              level="Intermediate"
            />
            <SkillItem
...
const SkillItem = ({ icon, stars, level }) => {
  return (
